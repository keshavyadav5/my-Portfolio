export const PERSONAL_INFO = {
  ...
  phone: "+917508794201",
  email: "kesavyadav992@gmail.com",
  linkedin: "https://linkedin.com/in/keshavyadav5",
  github: "https://github.com/keshavyadav5",
...
export const WORK_EXPERIENCE = [
  {
    ...
    responsibilities: [
      "Built interactive charts and dashboards by integrating APIs for data visualization",
      "Managed application state with state management libraries for responsive UIs",
      "Collaborated with teams to implement UI/UX designs, ensuring user-friendly solutions",
      "Maintained code integrity using version control systems for seamless collaboration"
    ]
  }
];
...
export const CERTIFICATIONS = [
  {
    ...
    issuer: "MongoDB",
    description: "Expertise in schema design, indexing, aggregation, and replication. CRUD operations and advanced queries optimization.",
    skills: ["Schema Design", "Indexing", "Aggregation", "Replication", "Performance Optimization"],
    link: "https://res.cloudinary.com/dlecrzota/image/upload/v1745902200/b4decee3-f2b8-4d2c-8ff5-00f644ccf30f.png"
  },
  {
    name: "React.js Development",
    issuer: "LinkedIn",
    description: "Built dynamic, responsive user interfaces with React.js. State management and performance optimization.",
    skills: ["React.js", "Context API", "Redux", "Lifecycle Methods", "Hooks", "Performance Optimization"],
